...
var EditDistribution = Backbone.View.extend({
  ...
  events: {
    'submit form#frmEditDistribution' : "editDistribution"
  },
  render: function(contacts, locs, di) {
    $(this.el).html( this.template({ contacts: contacts, locations: locs, distribution: di }) );
  },
  datas: function(id) {
    var self = this;
    $(".loading-message").show();
